...
static class HighScoreController
{
	...
	public static void DrawHighScores()
	{
		...
		SwinGame.DrawText("   High Scores   ", Color.Yellow, GameResources.GameFont("Courier"), SCORES_LEFT, SCORES_HEADING);
		...
		for (i = 0; i <= _Scores.Count - 1; i++) {
			...
			if (i < 9) {
				SwinGame.DrawText(" " + (i + 1) + ":   " + s.Name + "   " + s.Value, Color.Yellow, GameResources.GameFont("Courier"), SCORES_LEFT, SCORES_TOP + i * SCORE_GAP);
			} else {
				SwinGame.DrawText(i + 1 + ":   " + s.Name + "   " + s.Value, Color.Yellow, GameResources.GameFont("Courier"), SCORES_LEFT, SCORES_TOP + i * SCORE_GAP);
			}
		}
